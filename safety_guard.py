...
_NG_TERMS = {
    # 2026-07-23 さらに緩和: ギャル系・軽セクシー路線を許容。
    #   許容: えち/抜ける等の軽い言い回し、下着/ランジェリー
    #   禁止のまま: 露骨な性表現・成人向けを直接示す語・部位強調語
    "adult": [
        "エロ", "えろ", "ero", "18禁", "r18", "r-18",
        "成人向け", "порн", "porn", "xxx", "nsfw",
        "ヌード", "nude",
        "巨乳", "美乳", "おっぱい", "谷間", "av女優",
        "fanza", "dlsite", "dmm",
    ],
    # 2026-07-23 方針転換: はてなも MuscleLove ブランド＋自分のサービス誘導を
    #   出す運用にする（ユーザー決定）。自分の公式導線(Patreon/X/MuscleLove)は
    #   許容し、brandブロックは「他ブランド／内部インフラの誤露出防止」に限定。
    "brand": [
        "eronavi", "musclelove-777",
    ],
    "internal": [
